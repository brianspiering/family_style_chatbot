...
Seseame Oil Chicken WIngs
Chinese Mabo Tofu
General Tsao's Chicekn'
...
persona_designer = function(score_range, portion_modifier, noise) {
  ...
  score_range = sample(score_range, length(score_range))
  portion_modifier = sample(portion_modifier, length(portion_modifier))
  sapply(1:6
